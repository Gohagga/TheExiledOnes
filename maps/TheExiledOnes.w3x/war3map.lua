...
function CreateAllItems()
    ...
    BlzCreateItemWithSkin(FourCC("IA00"), -6243.1, -10501.9, FourCC("IA00"))
    BlzCreateItemWithSkin(FourCC("IA01"), -6358.0, -10539.9, FourCC("IA01"))
    BlzCreateItemWithSkin(FourCC("IA02"), -6341.9, -10439.6, FourCC("IA02"))
    BlzCreateItemWithSkin(FourCC("IA03"), -6307.4, -10512.1, FourCC("IA03"))
    BlzCreateItemWithSkin(FourCC("IA04"), -6326.3, -10596.1, FourCC("IA04"))
    BlzCreateItemWithSkin(FourCC("IA05"), -6398.1, -10510.0, FourCC("IA05"))
    BlzCreateItemWithSkin(FourCC("IA06"), -6392.1, -10586.6, FourCC("IA06"))
    BlzCreateItemWithSkin(FourCC("IA07"), -6299.3, -10462.7, FourCC("IA07"))
    BlzCreateItemWithSkin(FourCC("IM04"), -6318.6, -10833.1, FourCC("IM04"))
    BlzCreateItemWithSkin(FourCC("IMF1"), -7337.5, -12183.4, FourCC("IMF1"))
    BlzCreateItemWithSkin(FourCC("IMF1"), -7148.5, -12086.7, FourCC("IMF1"))
    BlzCreateItemWithSkin(FourCC("IMF1"), -7358.1, -12044.1, FourCC("IMF1"))
    BlzCreateItemWithSkin(FourCC("IMF1"), -7240.2, -11852.0, FourCC("IMF1"))
    BlzCreateItemWithSkin(FourCC("IMF1"), -7361.0, -12113.7, FourCC("IMF1"))
    ...
    BlzCreateItemWithSkin(FourCC("IMM1"), -7258.8, -11945.6, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7189.9, -11981.3, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7237.4, -12035.0, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7269.4, -12109.3, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7318.7, -11811.4, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7186.2, -12224.7, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7110.0, -12181.3, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -12275.0, -12444.5, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7103.5, -12043.7, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7196.7, -12119.7, FourCC("IMM1"))
    BlzCreateItemWithSkin(FourCC("IMM1"), -7347.0, -11961.8, FourCC("IMM1"))
...
function CreateBuildingsForPlayer0()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("E000"), -6848.0, -11520.0, 270.000, FourCC("E000"))
